...
namespace GameDevTV.RTS.Behavior
{
    ...
    [EventChannelDescription(name: "GatherSuppliesEventChannel", message: "[Agent] gathers [Amount] [Supplies] .", category: "Events", id: "005c0743a2e96d985e33a1feeef75d29")]
    public partial class GatherSuppliesEventChannel : EventChannelBase
    {
        public delegate void GatherSuppliesEventChannelEventHandler(GameObject Agent, int Amount, SupplySO Supplies);
        public event GatherSuppliesEventChannelEventHandler Event;

        public void SendEventMessage(GameObject Agent, int Amount, SupplySO Supplies)
        {
            Event?.Invoke(Agent, Amount, Supplies);
        }
        ...
        {
            GatherSuppliesEventChannelEventHandler del = (Agent, Amount, Supplies) =>
            {
